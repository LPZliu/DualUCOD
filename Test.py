...
import os, argparse
import cv2
from lib.dino_netwrok import Network
from utils.data_val import test_dataset

os.environ["CUDA_VISIBLE_DEVICES"] = '1'

parser = argparse.ArgumentParser()
parser.add_argument('--testsize', type=int, default=476, help='testing size') # 
parser.add_argument('--pth_path', type=str, default='./checkpoint/Net_epoch_best.pth') 
